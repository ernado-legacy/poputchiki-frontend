            ...
            success: =>
                app.models.myuser.get (user) =>
                    @$el.html jade.templates.top_bar
                        ...
                        cvideo: $.cookie "video"
                        cwebp: $.cookie "webp"
                        ipad: (navigator.userAgent.search('iPad')!=-1) or (navigator.userAgent.search('iPhone')!=-1) or (navigator.userAgent.search('Android')!=-1)
                    ...
                    for i in [0..2]
                        $('.promoPopup .changeAvatarBox').append jade.templates.top_bar_crs_item
                            ...
                            cvideo: $.cookie "video"
                            cwebp: $.cookie "webp"
                            ipad: (navigator.userAgent.search('iPad')!=-1) or (navigator.userAgent.search('Android')!=-1)
